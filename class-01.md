...
Anyone who has a website and wants more control over the appearance of their pages.
...
HTML:We will spend the first chapter looking at how HTML is used to create web pages.
CSS: We start this section with a chapter that explains how CSS uses rules to enable you to control the styling and layout of web pages.
...
How the Web Works: When you visit a website, the web server hosting that site could be anywhere in the world. In order for you to find the location of the web server, your browser will first connect to a Domain Name System (DNS) server. # chapter1: Structure
...
Escape characters are used to include special characters in your pages such as <, >, and ©. # chapter17:HTML5 layout
...
Older browsers that do not understand HTML5 elements need to be told which elements are block-level elements. # chapter18:Process & Design
